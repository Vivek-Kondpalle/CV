    ...
    return (
        <div className='aboutContainer'>
            <div className='aboutInfo'>
                <p>Hello , I am Vivek Kondpalle, Full stack Engineer. I have 1 year experience working with Laravel and Angular. I have also worked with React, React Native, Nodejs, Expressjs, MongoDB.
                </p>
